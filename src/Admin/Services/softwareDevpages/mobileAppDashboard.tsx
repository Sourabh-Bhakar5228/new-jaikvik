...
const MobileApplicationAdmin = () => {
  const initialSections: Section[] = [
    {
      id: "what-are-mobile-apps",
      title: "What Are Mobile Applications?",
      content: `<p className="text-gray-200 leading-relaxed text-lg md:text-xl font-medium mb-6">
      ...
      <p className="text-gray-200 leading-relaxed text-lg md:text-xl font-medium mb-6">
      ...
      image:
        "https://img.freepik.com/free-photo/representation-user-experience-interface-design_23-2150169865.jpg",
      alt: "Mobile Application Solutions",
      locked: false,
    },
    {
      id: "what-do-apps-do",
      title: "What Do Mobile Apps Do?",
      content: `<p className="text-gray-200 leading-relaxed text-lg md:text-xl font-medium mb-6">
      ...
      image:
        "https://img.freepik.com/premium-photo/application-interface-ui-smartphone-3d-rendering_110893-146.jpg",
    ...
    {
      id: "why-choose-apps",
      title: "Why Choose Mobile Apps for Your Business?",
      content: `<p className="text-gray-200 leading-relaxed text-lg md:text-xl font-medium mb-6">
      ...
      image:
        "https://img.freepik.com/premium-photo/businessman-using-smartphone-with-tablet-surrounding-by-app-social-icon-3d-render_110893-306.jpg",
    ...
    },
    {
      ...
      <ul className="list-disc list-inside text-gray-200 leading-relaxed text-lg md:text-xl font-medium mb-6 space-y-3">
        <li>
      ...
      image:
        "https://img.freepik.com/free-photo/representations-user-experience-interface-design_23-2150038902.jpg",
  ...
  const initialTestimonials: Testimonial[] = [
    {
      quote:
        "Jaikvik's mobile app transformed our customer engagement, increasing our user retention by 40%.",
      author: "Sarah Johnson",
      company: "Retail Solutions Inc.",
    },
    {
      quote:
        "The app developed by Jaikvik Technology streamlined our operations and reduced processing time by 30%.",
      author: "Michael Chen",
  ...
  useEffect(() => {
    const savedSections = localStorage.getItem("mobileAppSections");
    const savedTestimonials = localStorage.getItem("mobileAppTestimonials");
  ...
  useEffect(() => {
    localStorage.setItem("mobileAppSections", JSON.stringify(sections));
    localStorage.setItem("mobileAppTestimonials", JSON.stringify(testimonials));
    ...
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-red-500 mb-6">
          Mobile Application Content Admin
        </h1>
...
export default MobileApplicationAdmin;
