    ...
    <>
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white bg-black/60 bg-opacity-50 p-5 rounded-lg w-auto">
          ...
          <p className="text-lg md:text-base sm:text-sm m-0">
            Discover the latest insights, trends, and tips in digital marketing,
            SEO, web development, and more from Jaikvik Technology.
          </p>
        </div>
      </div>
      ...
      <section className="blogPage container mx-auto px-4 py-8">
        <div className="blogPageHeading text-center mb-8">
          ...
          <p className="text-lg">
            Our latest news is that we have experienced significant growth in
            our company's revenue for the quarter. We attribute this success to
            our strategic partnerships with key clients, our commitment to
            providing exceptional customer service, and the implementation of
