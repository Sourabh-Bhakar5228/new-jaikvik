...
const ArrowLeft: React.FC<{ onClick?: () => void, className?: string; }> = ({
    onClick,
    className = '',
}) => {
    return (
        <div className={`absolute z-50 left-2.5 top-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 cursor-pointer ${className}`} onClick={onClick}>
